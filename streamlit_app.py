...
def make_text_clip(text, start_time, end_time):
    return TextClip(text, fontsize=66, color='white', font='Arial') \
...
if uploaded_file is not None:
    ...
    text_lines = [
        ...
        for i in range(4)  # Assuming you want up to 4 lines of text
    ]
    ...
    if st.button("Create Video"):
        with st.spinner('Processing video...'):
            ...
            st.download_button('Download Video', data=open(output_video_path, 'rb'), file_name='output_video.mp4')
else:
